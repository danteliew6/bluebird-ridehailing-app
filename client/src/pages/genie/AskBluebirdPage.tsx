        ...
        <>
          <Alert>
            <AlertDescription className="text-xs">
              ...
              Genie experience embedded as-is — the identical space that powers the white-labeled chat.
              Use it to compare the raw product against the branded surface analysts get in this app.
            </AlertDescription>
          </Alert>
