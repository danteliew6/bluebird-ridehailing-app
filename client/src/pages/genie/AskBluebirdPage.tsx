        ...
        <>
          <Alert>
            <AlertDescription className="text-xs">
              ...
              Databricks chrome. This tab launches the native Databricks Genie experience for the same
              space, so you can compare the raw product against the branded surface analysts get here.
            </AlertDescription>
          </Alert>
          ...
          <div className="border rounded-xl bg-card shadow-sm p-8 flex flex-col items-center justify-center text-center gap-4 min-h-[340px]">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground max-w-md mt-1">
                The native Genie space in full Databricks chrome. Genie rooms can&apos;t be iframed into
                other apps (workspace security policy blocks cross-domain framing), so it opens in a new tab.
              </p>
            </div>
            ...
            <p className="text-xs text-muted-foreground max-w-md">
              ...
              runs the same governed space natively — with the same Unity Catalog masks and row-filters enforced.
            </p>
          </div>
        </>
      )}
